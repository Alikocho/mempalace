...
from decisionsupport.delphi import (
    DelphiDB,
    compute_stats,
)
...
class TestDelphiCLI:
    def _run(self, args, db):
        ...
        from decisionsupport.delphi_cli import _build_parser

        parser = _build_parser()
        parsed = parser.parse_args(args)
        out = StringIO()
        with patch("sys.stdout", out), patch("decisionsupport.delphi_cli._db", return_value=db):
            if parsed.command == "round":
                from decisionsupport.delphi_cli import cmd_round
                ...
                import decisionsupport.delphi_cli as dcli
    ...
    def test_export_to_stdout(self, tmp_path):
        ...
        from decisionsupport.delphi_cli import cmd_export, _build_parser
