...
def app(tmp_path, monkeypatch):
    monkeypatch.setenv("DECISION_SUPPORT_DATA_DIR", str(tmp_path))
    monkeypatch.setenv("SECRET_KEY", "test-secret")

    # Re-import web so it picks up the patched env var
    import importlib
    import decisionsupport.web as web_module
...
class TestCynefinRoutes:
    ...
    def test_assess_saves_and_redirects(self, client):
        ...
        from decisionsupport.cynefin import QUESTIONS
...
class TestDelphiRoutes:
    ...
    def test_rate_records(self, client):
        ...
        # Get item_id from DB
        import decisionsupport.web as wm
        db = wm._ddb()
