#!/usr/bin/env python3
"""
MemPalace Decision Support — Web Interface

Flask application wrapping Cynefin and Delphi decision support tools.

Environment variables:
    MEMPALACE_DATA_DIR   Path for SQLite databases (default: ~/.mempalace)
...
DATA_DIR = Path(os.environ.get("MEMPALACE_DATA_DIR", str(Path.home() / ".mempalace")))
